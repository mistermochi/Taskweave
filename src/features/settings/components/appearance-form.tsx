            ...
            {Object.entries(THEME_COLORS).map(([key, value]) => {
              ...
              return (
                <button
                  ...
                  className="flex items-center justify-center p-0.5 rounded-full transition-all active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                  title={value.name}
